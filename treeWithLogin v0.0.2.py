...
class Person:
    def __init__(self,id, x=100, y=100, r=80, name="", surname="", bornYear=0, img=[],relations = {"parents": [], "childrens": [], "siblings": [], "partner": []},colors=[(7, 56, 99), (107, 56, 99)],costume =0,bool=False,current = False,isclickedR = False,isclickedL = False,time = 0) -> None:
        self.id = id
        self.x = x
        self.y = y
        self.r = r
        ...
        while run:
            ...
            for person in list((self.persons).values()):
                ...
                for indx in person.relations["siblings"]:
                    pygame.draw.line(self.win, (0, 0, 0), (self.persons[indx].x, self.persons[indx].y), (person.x, person.y), 5)
                ...
                for indx in person.relations["childrens"]:
                    if person.relations["partner"] != []:
                        ...
                        pygame.draw.line(self.win, (81, 81, 81), (self.persons[indx].x, self.persons[indx].y), (person.x, person.y), 5)

                for indx in person.relations["partner"]:
                    pygame.draw.line(self.win, (162, 162, 162), (self.persons[indx].x, self.persons[indx].y), (person.x, person.y), 5)
